...
public class isManyBranchingTests extends FeedbackCase {
    ...
    public void testNull() {
        ...
        try {
            ((Question1)answer).isManyBranching(null);
    ...
    public void testBranch1() {
        setTree(new TreeNode("dummy"));
        try {
            assertTrue(null, "Failed to correctly spot a leaf node!", !((Question1)answer).isManyBranching(new TreeNode("leaf")));
        } catch(Throwable exn) {
    ...
    public void testBranch2() {
        ...
        try {
            ...
            node.setBranch(null);
            ((Question1)answer).isManyBranching(node);
    ...
    public void testBranch3() {
        setTree(new TreeNode("dummy"));
        try {
            assertTrue(null, "Failed to correctly diagnose a 1-branching node!", !((Question1)answer).isManyBranching(new TreeNode("root", 1)));
        } catch(Throwable exn) {
            fail(exn, "An inappropriate exception was thrown: " + exn.getClass().getName());
        } // end of try-catch
    ...
    public void testBranch4() {
        setTree(new TreeNode("dummy"));
        try {
            assertTrue(null, "Failed to correctly diagnose a multiply-branching node!", ((Question1)answer).isManyBranching(new TreeNode("root", 2)));
        } catch(Throwable exn) {
            fail(exn, "An inappropriate exception was thrown: " + exn.getClass().getName());
        } // end of try-catch
...
} // end of class isManyBranchingTests
